...
using System.Collections.Generic;
	...
	public class InputManager : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			VirtualAxes.Add(eInput.INPUT_HORIZONTAL_RAW, new InputAxes(eInput.INPUT_HORIZONTAL_RAW));
			VirtualAxes.Add(eInput.INPUT_VERTICAL_RAW, new InputAxes(eInput.INPUT_VERTICAL_RAW));
		...
		private void keyboardInput()
		{
			...
			VirtualAxes[eInput.INPUT_HORIZONTAL_RAW].UpdateValue(Input.GetAxisRaw("Horizontal"));
			VirtualAxes[eInput.INPUT_VERTICAL_RAW].UpdateValue(Input.GetAxisRaw("Vertical"));
	}
